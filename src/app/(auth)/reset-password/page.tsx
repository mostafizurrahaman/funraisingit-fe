  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#26343a] px-4 py-8">
      <section className="w-full max-w-[360px] rounded-lg bg-white px-5 py-10 shadow-xl">
        ...
        <div className="mt-7 text-center"><h1 className="text-2xl font-semibold tracking-tight">Reset your password</h1><p className="mx-auto mt-1 max-w-[285px] text-[11px] leading-4">Create a new password for your account and make to choose a strong and unique password.</p></div>
