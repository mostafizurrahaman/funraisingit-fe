          ...
          <Sheet open={open} onOpenChange={setOpen}>
            <SheetTrigger asChild>
              <button
                ...
                className="inline-flex size-10 items-center justify-center rounded-lg border border-border text-foreground transition-all duration-300 hover:border-secondary hover:bg-secondary/10 hover:text-secondary lg:hidden"
              >
            ...
            <SheetContent className="left-0 right-auto w-[82%] max-w-72 translate-x-0 border-l-0 border-r p-0 data-[state=closed]:-translate-x-full">
              ...
              <DashboardSidebar
                className="static flex h-dvh w-full border-r-0"
